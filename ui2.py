...
def main(manager_de_red): # <-- Acepta el manager de red
    ...
    while running:
        ...
        #    contJugador +=1
        #    print(f" Recibido por el jugador... {contJugador, msgGame}  ")
        #else:
        #    msgGame = network_manager.get_moves_game()
        #    contHost +=1
        #    print(f" Recibido por el Host ...  {contHost, msgGame}")
            #msgGame = []
        ...
        for msg in msgGame:
            if isinstance(msg,dict) and msg.get("type")=="BAJARSE":
                ...
                if received_round:
                    ...
                    #print(f"Mazo de cartas pile {round.pile}")
                    #print(f"Mazo de cartas DeckForRound {deck_for_round}")
                    #print(f"Mazo de cartas discards {round.discards}")
                    #print(f"Mazo de cartas Mazo_Descarte {mazo_de_descarte}")
